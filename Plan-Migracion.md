...
| 7  | `contenidos/2-taller-de-go/2-3-arreglos-slices.md` | ⬜ Pendiente |
| 8  | `contenidos/2-taller-de-go/2-4-maps.md` | ⬜ Pendiente |
| 9  | `contenidos/2-taller-de-go/2-5-funciones.md` | ⬜ Pendiente |
| 10 | `contenidos/2-taller-de-go/2-6-punteros.md` | ⬜ Pendiente |
| 11 | `contenidos/2-taller-de-go/2-7-errores.md` | ⬜ Pendiente |
| 12 | `contenidos/2-taller-de-go/2-8-structs-interfaces.md` | ⬜ Pendiente |
| 13 | `contenidos/2-taller-de-go/2-9-exportado-no-exportado.md` | ⬜ Pendiente |
| 14 | `contenidos/2-taller-de-go/2-10-oop.md` | ⬜ Pendiente |
| 15 | `contenidos/3-estructuras-de-datos/3-1-tad.md` | ⬜ Pendiente |
| 16 | `contenidos/3-estructuras-de-datos/3-2-pilas-colas.md` | ⬜ Pendiente |
| 17 | `contenidos/3-estructuras-de-datos/3-3-listas.md` | ⬜ Pendiente |
| 18 | `contenidos/3-estructuras-de-datos/3-4-conjuntos.md` | ⬜ Pendiente |
| 19 | `contenidos/3-estructuras-de-datos/3-5-mapa-de-bits.md` | ⬜ Pendiente |
| 20 | `contenidos/3-estructuras-de-datos/3-6-tablas-de-hashing.md` | ⬜ Pendiente |
| 21 | `contenidos/3-estructuras-de-datos/3-7-diccionarios.md` | ⬜ Pendiente |
| 22 | `contenidos/3-estructuras-de-datos/3-8-arboles.md` | ⬜ Pendiente |
| 23 | `contenidos/3-estructuras-de-datos/3-9-abb.md` | ⬜ Pendiente |
| 24 | `contenidos/3-estructuras-de-datos/3-10-arboles-balanceados.md` | ⬜ Pendiente |
| 25 | `contenidos/3-estructuras-de-datos/3-11-monticulo-binario.md` | ⬜ Pendiente |
| 26 | `contenidos/3-estructuras-de-datos/3-12-iteradores-abb.md` | ⬜ Pendiente |
| 27 | `contenidos/4-diseno-de-algoritmos/4-1-recursividad.md` | ⬜ Pendiente |
| 28 | `contenidos/4-diseno-de-algoritmos/4-2-patrones-de-diseno.md` | ⬜ Pendiente |
| 29 | `contenidos/4-diseno-de-algoritmos/4-3-algoritmos-avidos.md` | ⬜ Pendiente |
| 30 | `contenidos/4-diseno-de-algoritmos/4-4-backtracking.md` | ⬜ Pendiente |
| 31 | `contenidos/4-diseno-de-algoritmos/4-5-programacion-dinamica.md` | ⬜ Pendiente |
| 32 | `contenidos/4-diseno-de-algoritmos/4-6-ordenamientos-recursivos.md` | ⬜ Pendiente |
| 33 | `contenidos/4-diseno-de-algoritmos/4-7-ordenamientos-lineales.md` | ⬜ Pendiente |
| 34 | `contenidos/5-taller-de-git/5-1-introduccion-git.md` | ⬜ Pendiente |
| 35 | `contenidos/bibliografia.md` | ⬜ Pendiente |

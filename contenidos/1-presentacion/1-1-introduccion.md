...
Los algoritmos no son exclusivos de la **informática**, se utilizan también en otras disciplinas, estrechamente vinculadas a la computación, como las **matemáticas** y la **lógica**.
...
Para poder regularizar la cursada es necesario aprobar dos parciales; cada uno se aprueba con 4 o más. Además, se debe presentar y aprobar un proyecto grupal que tendrá entregas parciales y una presentación final (oral y escrita).

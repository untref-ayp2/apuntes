...
- Los programas son almacenados en la memoria secundaria.
- Al momento de lanzar la ejecución de un programa, el conjunto de instrucciones que lo componen es copiado a la memoria central.
...
- **_Code Segment_ (Segmento de Código)**:
...
```{figure} ../assets/images/esquemaDeMemoria.svg
---
...
Go combina lo mejor de ambos mundos:
...
### Algoritmo _Tricolor Mark-Sweep_
...
- Go minimiza los _stop-the-world_ (momentos en los que detiene completamente la ejecución para limpiar memoria).

...
En la siguiente imagen se muestra un esquema de la memoria de un proceso en ejecución. Cada segmento de memoria tiene un tamaño y una función específica en el programa. La figura es solo a modo didáctico y no representa la organización real de la memoria en Go, que es más compleja.
...
En Go, las variables se almacenan en el _**stack**_ o en el _**heap**_ dependiendo de su alcance, duración y cómo se utilizan. Por ejemplo, dado el siguiente fragmento de código:
...
p4.direccion = dir
```
El _**stack**_ y el _**heap**_ presentaran el siguiente estado:

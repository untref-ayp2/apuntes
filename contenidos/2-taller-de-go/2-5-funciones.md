...
Los _slices_ y los _maps_ son excepciones aparentes: la estructura que los representa (puntero, longitud, capacidad) se copia, pero tanto el original como la copia comparten el mismo arreglo subyacente. Esto se cubre en detalle en el capítulo de arreglos y slices.
...
Esto permite pasar funciones como argumentos a otras funciones, lo que es la base de patrones como _callbacks_ y funciones de orden superior.

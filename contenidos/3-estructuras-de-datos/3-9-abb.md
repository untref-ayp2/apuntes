...
4. Implementar un iterador Preorden para un árbol binario de búsqueda.
5. Implementar un iterador Postorden para un árbol binario de búsqueda.
6. Implementar un iterador por niveles para un árbol binario de búsqueda. Tal que primero devuelve la raíz, luego los hijos de la raíz que se encuentran en el nivel 1, luego los hijos de los nodos del nivel 1 que se encuentran en el nivel 2 y así sucesivamente.

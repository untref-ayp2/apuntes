...
En INSERTAR REPO. Se encuentra una implementación de la lista enlazada simple
...
## Ejercicios
1. Implementar una lista enlazada doble, similar a la lista simple dada.
2. Implementar una lista enlazada doble con centinelas.
3. Analizar pros y contra de cada una de las implementaciones realizadas.

...
TEXT_MOVES = [
    ...
    (
        f'x="514.5" y="203">calle{NBSP}string = "Av. Corrientes"',
        f'x="934.5" y="43">calle{NBSP}string = "Av. Corrientes"',
    ),
    ('x="514.5" y="217">ciudad string = "CABA"', 'x="934.5" y="57">ciudad string = "CABA"'),
    (
        f'x="514.5" y="231">provincia{NBSP}string = "Buenos Aires"',
        f'x="934.5" y="71">provincia{NBSP}string = "Buenos Aires"',
    ),
    ...
    (
        f'x="704.5" y="103">calle{NBSP}string = "Valentín Gomez"',
        f'x="584.5" y="153">calle{NBSP}string = "Valentín Gomez"',
    ),
    ('x="704.5" y="117">ciudad string = "Caseros"', 'x="584.5" y="167">ciudad string = "Caseros"'),
    (
        f'x="704.5" y="131">provincia{NBSP}string = "Buenos Aires"',
        f'x="584.5" y="181">provincia{NBSP}string = "Buenos Aires"',
    ),
...
ARROW_REPLACEMENTS = [
    ...
    ("M 180 20 Q 210 10 240 17 Q 270 25 300 25 Q 330 25 373.9 11", "M 180 20 Q 200 20 240 50 Q 260 50 293.63 50"),
    ("M 378.93 80 L 373.23 45 L 371.22 78 Z", "M 298.88 50 L 291.88 47 L 291.88 53 Z"),
    # Arrow 2: p3 (180,80) -> Persona(p3) at (300,140..200, center ~170)
    # Was: M 180 80 Q 230 250 353.63 250
    ("M 180 80 Q 230 250 353.63 250", "M 180 80 Q 200 80 240 170 Q 260 170 293.63 170"),
    ("M 238 140 L 231 143 L 231 136 Z", "M 298.88 170 L 291.88 167 L 291.88 173 Z"),
    ...
    ("M 379.14 55 L 376 62 L 371.52 57 Z", "M 298.88 70 L 291.88 67 L 291.88 73 Z"),
    ...
    ("M 180 200 Q 240 330 315 200 Q 390 370 503.82 191", "M 180 200 Q 220 200 220 45 Q 220 45 923.63 45"),
    ("M 508.92 220 L 502.97 225 L 501.28 218 Z", "M 928.88 45 L 921.88 42 L 921.88 48 Z"),
    ...
    ("M 180 310 Q 200 310 240 90 Q 280 70 333.63 70", "M 180 310 Q 220 310 293.63 310"),
    ("M 218 320 L 211 323 L 211 316 Z", "M 298.88 310 L 291.88 307 L 291.88 313 Z"),
    ...
    ("M 554 60 Q 660 60 753.63 60", "M 514 60 Q 600 60 693.63 60"),
    ("M 758.88 60 L 751.88 63 L 751.88 56 Z", "M 698.88 60 L 691.88 63 L 691.88 57 Z"),
    ...
    ("M 554 60 Q 600 60 620 110 Q 640 110 648.75 303.76", "M 514 50 Q 700 50 923.63 50"),
    ("M 649.78 308.9 L 644.98 302.73 L 651.84 301.35 Z", "M 928.88 50 L 921.88 47 L 921.88 53 Z"),
    ...
    ("M 535 120 Q 600 120 625 140 Q 650 120 693.63 120", "M 514 170 Q 540 170 573.63 170"),
    ("M 698.88 120 L 691.88 123 L 691.88 116 Z", "M 578.88 170 L 571.88 173 L 571.88 167 Z"),
    ...
    ("M 514 300 Q 570 300 605 320 Q 640 300 693.63 300", "M 494 310 Q 520 310 553.63 310"),
    ("M 698.88 300 L 691.88 303 L 691.88 296 Z", "M 558.88 310 L 551.88 313 L 551.88 307 Z"),
]


def fix_titles(svg):
    svg = re.sub(
        r'(y="19\.5"[^>]*font-weight="bold"[^>]*>Stack<)', lambda m: m.group(0).replace('y="19.5"', 'y="12"'), svg
    )
    svg = re.sub(
